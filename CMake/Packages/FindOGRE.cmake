...
if (OGRE_INCLUDE_DIR)
  ...
  if (OGRE_CONFIG_HEADER)
    ...
    get_preprocessor_entry(OGRE_TEMP_CONFIG_CONTENT __OGRE_HAVE_SSE OGRE_CONFIG_SSE)
    get_preprocessor_entry(OGRE_TEMP_CONFIG_CONTENT __OGRE_HAVE_NEON OGRE_CONFIG_NEON)
    if (OGRE_CONFIG_SSE)
      set(OGRE_INCLUDE_DIRS ${OGRE_INCLUDE_DIRS} ${OGRE_INCLUDE_DIR}/Math/Array/SSE2/Single)
    elseif (OGRE_CONFIG_NEON)
      set(OGRE_INCLUDE_DIRS ${OGRE_INCLUDE_DIRS} ${OGRE_INCLUDE_DIR}/Math/Array/Neon/Single)
    else ()
      set(OGRE_INCLUDE_DIRS ${OGRE_INCLUDE_DIRS} ${OGRE_INCLUDE_DIR}/Math/Array/C)
    endif()

    set(OGRE_INCLUDE_DIRS ${OGRE_INCLUDE_DIRS} ${OGRE_INCLUDE_DIR}/Math/Simple/C)
