...
find_library(AMDAGS_BINARY_REL NAMES ${AMDAGS_BINARY_NAMES} HINTS ${AMDAGS_LIB_SEARCH_PATH} ${AMDAGS_PKGC_LIBRARY_DIRS} PATH_SUFFIXES "" release relwithdebinfo minsizerel)
find_library(AMDAGS_BINARY_DBG NAMES ${AMDAGS_BINARY_NAMES_DBG} HINTS ${AMDAGS_LIB_SEARCH_PATH} ${AMDAGS_PKGC_LIBRARY_DIRS} PATH_SUFFIXES "" debug)
