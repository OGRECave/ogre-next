...
# configure SIMD before generating OgreBuildSettings
set(OGRE_SIMD_SSE2 0 CACHE BOOL "" FORCE)
set(OGRE_SIMD_NEON 0 CACHE BOOL "" FORCE)
mark_as_advanced(OGRE_SIMD_SSE2)
mark_as_advanced(OGRE_SIMD_NEON)

if (OGRE_SIMD AND ${CMAKE_SYSTEM_PROCESSOR} MATCHES "(x86)|(X86)|(amd64)|(AMD64)")
  set(OGRE_SIMD_SSE2 1 CACHE BOOL "" FORCE)
  if (OGRE_CONFIG_DOUBLE)
	  message(FATAL_ERROR "Double precision with SSE2 SIMD is not supported")
  else()
    include_directories("${OGRE_SOURCE_DIR}/OgreMain/include/Math/Array/SSE2/Single")
  endif()
elseif (OGRE_SIMD AND ${CMAKE_SYSTEM_PROCESSOR} MATCHES "arm")
  set(OGRE_SIMD_NEON 1 CACHE BOOL "" FORCE)
  if (OGRE_CONFIG_DOUBLE)
	  message(FATAL_ERROR "Double precision with Neon SIMD is not supported")
  else()
    include_directories("${OGRE_SOURCE_DIR}/OgreMain/include/Math/Array/Neon/Single")
  endif()
elseif (OGRE_SIMD)
...
set(OGRE_SET_USE_SIMD_SSE2 0)
set(OGRE_SET_USE_SIMD_NEON 0)
...
if (OGRE_SIMD_SSE2)
  set(OGRE_SET_USE_SIMD_SSE2 1)
endif()
if (OGRE_SIMD_NEON)
  set(OGRE_SET_USE_SIMD_NEON 1)
endif()
