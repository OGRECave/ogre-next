...
namespace Demo
{
    ...
    void ParticleFX2GameState::createScene01()
    {
        ...
        {
            Ogre::ParticleSystem2 *pSystem3 =
                sceneManager->createParticleSystem2( "Particle/SpherePBS" );
        ...
        Ogre::ParticleSystem2 *pSystem0 =
            sceneManager->createParticleSystem2( "Examples/PurpleFountain" );
