...
MainWindowBase::MainWindowBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_menuItem61 = new wxMenuItem( m_menuEdit, wxID_UNDO, wxString( _("&Undo") ) + wxT('\t') + wxT("Ctrl+Z"), wxEmptyString, wxITEM_NORMAL );
...
PbsParametersPanelBase::PbsParametersPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_fresnelSlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_fresnelSlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_fresnelSlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsParametersPanelBase::UndoKeyUp ), NULL, this );
	m_fresnelSlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsParametersPanelBase::UndoKillFocus ), NULL, this );
	m_fresnelSlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_fresnelSlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_fresnelSlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_fresnelSlider->Connect( wxEVT_SLIDER, wxCommandEventHandler( PbsParametersPanelBase::OnSlider ), NULL, this );
	m_roughnessSlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_roughnessSlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_roughnessSlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsParametersPanelBase::UndoKeyUp ), NULL, this );
	m_roughnessSlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsParametersPanelBase::UndoKillFocus ), NULL, this );
	m_roughnessSlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_roughnessSlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_roughnessSlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	...
	m_transparencySlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_transparencySlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_transparencySlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsParametersPanelBase::UndoKeyUp ), NULL, this );
	m_transparencySlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsParametersPanelBase::UndoKillFocus ), NULL, this );
	m_transparencySlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_transparencySlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
	m_transparencySlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsParametersPanelBase::UndoMouseUp ), NULL, this );
...
PbsTexturePanelBase::PbsTexturePanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_normalMapSlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_normalMapSlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_normalMapSlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_normalMapSlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_normalMapSlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_normalMapSlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_normalMapSlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapSlider0->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider0->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider0->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapSlider0->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapSlider0->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider0->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider0->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailNmMapSlider0->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider0->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider0->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailNmMapSlider0->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailNmMapSlider0->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider0->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider0->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapXSlider0->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider0->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider0->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapXSlider0->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapXSlider0->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider0->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider0->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapYSlider0->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider0->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider0->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapYSlider0->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapYSlider0->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider0->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider0->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapWSlider0->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider0->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider0->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapWSlider0->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapWSlider0->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider0->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider0->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapHSlider0->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider0->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider0->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapHSlider0->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapHSlider0->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider0->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider0->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapSlider1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider1->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider1->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapSlider1->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapSlider1->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider1->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider1->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailNmMapSlider1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider1->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider1->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailNmMapSlider1->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailNmMapSlider1->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider1->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider1->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapXSlider1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider1->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider1->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapXSlider1->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapXSlider1->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider1->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider1->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapYSlider1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider1->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider1->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapYSlider1->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapYSlider1->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider1->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider1->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapWSlider1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider1->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider1->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapWSlider1->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapWSlider1->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider1->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider1->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapHSlider1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider1->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider1->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapHSlider1->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapHSlider1->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider1->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider1->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapSlider2->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider2->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider2->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapSlider2->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapSlider2->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider2->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider2->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailNmMapSlider2->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider2->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider2->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailNmMapSlider2->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailNmMapSlider2->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider2->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider2->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapXSlider2->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider2->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider2->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapXSlider2->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapXSlider2->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider2->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider2->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapYSlider2->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider2->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider2->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapYSlider2->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapYSlider2->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider2->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider2->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapWSlider2->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider2->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider2->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapWSlider2->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapWSlider2->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider2->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider2->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapHSlider2->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider2->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider2->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapHSlider2->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapHSlider2->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider2->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider2->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapSlider3->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider3->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider3->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapSlider3->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapSlider3->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider3->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapSlider3->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailNmMapSlider3->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider3->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider3->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailNmMapSlider3->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailNmMapSlider3->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider3->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailNmMapSlider3->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapXSlider3->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider3->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider3->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapXSlider3->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapXSlider3->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider3->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapXSlider3->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapYSlider3->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider3->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider3->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapYSlider3->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapYSlider3->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider3->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapYSlider3->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapWSlider3->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider3->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider3->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapWSlider3->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapWSlider3->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider3->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapWSlider3->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	...
	m_detailMapHSlider3->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider3->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider3->Connect( wxEVT_KEY_UP, wxKeyEventHandler( PbsTexturePanelBase::UndoKeyUp ), NULL, this );
	m_detailMapHSlider3->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( PbsTexturePanelBase::UndoKillFocus ), NULL, this );
	m_detailMapHSlider3->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
	m_detailMapHSlider3->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( PbsTexturePanelBase::UndoMouseUp ), NULL, this );
...
LightPanelBase::LightPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_eulerXSlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerXSlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerXSlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( LightPanelBase::UndoKeyUp ), NULL, this );
	m_eulerXSlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( LightPanelBase::UndoKillFocus ), NULL, this );
	m_eulerXSlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerXSlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerXSlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	...
	m_eulerYSlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerYSlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerYSlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( LightPanelBase::UndoKeyUp ), NULL, this );
	m_eulerYSlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( LightPanelBase::UndoKillFocus ), NULL, this );
	m_eulerYSlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerYSlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerYSlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	...
	m_eulerZSlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerZSlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerZSlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( LightPanelBase::UndoKeyUp ), NULL, this );
	m_eulerZSlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( LightPanelBase::UndoKillFocus ), NULL, this );
	m_eulerZSlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerZSlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_eulerZSlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	...
	m_envStrengthSlider->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_envStrengthSlider->Connect( wxEVT_AUX2_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_envStrengthSlider->Connect( wxEVT_KEY_UP, wxKeyEventHandler( LightPanelBase::UndoKeyUp ), NULL, this );
	m_envStrengthSlider->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( LightPanelBase::UndoKillFocus ), NULL, this );
	m_envStrengthSlider->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_envStrengthSlider->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
	m_envStrengthSlider->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( LightPanelBase::UndoMouseUp ), NULL, this );
