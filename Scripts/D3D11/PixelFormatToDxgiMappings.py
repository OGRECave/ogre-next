...
for format in formats:
    #    dxgiFormat = format.replace( "PFG_", "DXGI_FORMAT_" );
    ...
    dxgiFormat = format.replace( "PFG_", "MTLPixelFormat" );
    dxgiFormat = dxgiFormat.replace( "_FLOAT", "Float" )
    dxgiFormat = dxgiFormat.replace( "_UINT", "Uint" )
    dxgiFormat = dxgiFormat.replace( "_UNORM", "Unorm" )
    dxgiFormat = dxgiFormat.replace( "_SNORM", "Snorm" )
    dxgiFormat = dxgiFormat.replace( "_SINT", "Sint" )
    dxgiFormat = dxgiFormat.replace( "_UNORM", "Uint" )
    final = "case " + format + ":\t\treturn " + dxgiFormat + ";"
    print( final )
